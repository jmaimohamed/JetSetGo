    ...
    private void animateImagesWithDifferentColors(ImageView... imageViews) {
        ...
        for (ImageView imageView : imageViews) {
            handler.postDelayed(() -> {
                ...
                @SuppressLint("ObjectAnimatorBinding") ObjectAnimator imageColorAnimator = ObjectAnimator.ofArgb(imageView.getDrawable(), "color", randomColorStart, randomColorEnd);
